...
\end{aligned}
$$
The dependent variable has been __
...
sumary(gala_pois)$coef
```
The deviance at this stage is still larger than the deviance from the GLM.
...
dev
```
These estiamte are much closer, and are nearly the same as the target
